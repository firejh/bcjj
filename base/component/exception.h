...
#define EXCEPTION(ExceptionType, formatMsg...)\
    throw ExceptionType(water::component::format(formatMsg), __FILE__, __PRETTY_FUNCTION__, __LINE__);


#define SYS_EXCEPTION(ExceptionType, formatMsg...)\
    throw ExceptionType(water::component::format(formatMsg), __FILE__, __PRETTY_FUNCTION__, __LINE__, errno);
