...
#define ON_EXIT_SCOPE(callback) water::component::ScopeGuard MACRO_CON(onExit, __LINE__)(callback)
#define ON_EXIT_SCOPE_DO(statements) water::component::ScopeGuard MACRO_CON(onExit, __LINE__)([&]{statements;})
